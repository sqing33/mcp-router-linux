...
> **Note**: This repository is a personal fork of the upstream project. Compared to `mcp-router/mcp-router`, it only adds Linux (Ubuntu `.deb`) packaging/release scripts (GitHub Actions + Electron Forge `maker-deb`); other content is kept as close to upstream as possible.
